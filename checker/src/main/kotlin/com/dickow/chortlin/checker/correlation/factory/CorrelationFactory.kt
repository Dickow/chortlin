...
object CorrelationFactory {
    ...
    @JvmStatic
    fun <R> correlation(method: Method0<*, R>, key: String, correlationFunction: CFunc0): CorrelationBuilder0<R> {
        val func = { _: Array<Any?> -> correlationFunction() }
        return CorrelationBuilder0(method, InputTypesFunction(key, func))
    }

    @JvmStatic
    fun <T1, R> correlation(method: Method1<*, T1, R>, key: String, correlationFunction: CFunc1<T1>): CorrelationBuilder1<T1, R> {
    ...
    @JvmStatic
    fun <T1, T2, R> correlation(method: Method2<*, T1, T2, R>, key: String, correlationFunction: CFunc2<T1, T2>): CorrelationBuilder2<T1, T2, R> {
        val func = { args: Array<Any?> ->
    ...
    @JvmStatic
    fun <T1, T2, T3, R> correlation(method: Method3<*, T1, T2, T3, R>, key: String, correlationFunction: CFunc3<T1, T2, T3>): CorrelationBuilder3<T1, T2, T3, R> {
        val func = { args: Array<Any?> ->
    ...
    @JvmStatic
    fun <T1, T2, T3, T4, R> correlation(method: Method4<*, T1, T2, T3, T4, R>, key: String, correlationFunction: CFunc4<T1, T2, T3, T4>): CorrelationBuilder4<T1, T2, T3, T4, R> {
        val func = { args: Array<Any?> ->
