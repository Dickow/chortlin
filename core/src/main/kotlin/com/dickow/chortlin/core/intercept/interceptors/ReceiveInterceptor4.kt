...
class ReceiveInterceptor4<TClass, T1, T2, T3, T4, R, TMappedInput, TProcessReturn> constructor(
        private val endpoint: (TClass, T1, T2, T3, T4) -> R,
        private val mapper: (T1, T2, T3, T4) -> TMappedInput,
    ...
    override fun invoke(proxy: Any?, method: Method?, args: Array<out Any>?): Any {
        if (methodName == method!!.name) {
            ...
            processor(mapper(arg1, arg2, arg3, arg4))
            return ""
        }
