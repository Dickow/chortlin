...
class ReceiveInterceptor2<TClass, T1, T2, R, TMappedInput, TProcessReturn> constructor(
        private val endpoint: (TClass, T1, T2) -> R,
        private val mapper: (T1, T2) -> TMappedInput,
