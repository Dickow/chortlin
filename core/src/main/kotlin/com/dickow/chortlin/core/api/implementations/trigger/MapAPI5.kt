...
(private val definition: TriggerBuilder, private val subscriber: Subscriber)
    ...
    override fun <T1, T2, T3, T4, T5, TMapped, R> handleWith(handler: IHandler5<T1, T2, T3, T4, T5, TMapped, R>): TriggerAPI<R> {
    ...
    override fun <TMapped> mapInputTo(mapper: (T1, T2, T3, T4, T5) -> TMapped): TriggerProcessAPI<TMapped> {
