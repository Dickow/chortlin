...
class TriggerAPI<TProcessed> constructor(
        private val definition: TriggerBuilder, private val subscriber: Subscriber) : TriggerAPI<TProcessed> {
    ...
    override fun finish(): Trigger {
        val trigger = definition.build()
        subscriber.onTriggerCompleted(trigger)
        return trigger
    }
}