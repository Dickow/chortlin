...
class OnlineInstrumentationTests {
    ...
    private val onlineFirstClass = participant(OnlineFirstClass::class.java) // "method1", OnlineFirstClass::method1
    private val onlineSecondClass = participant(OnlineSecondClass::class.java) // "method1", OnlineSecondClass::method1
    private val onlineThirdClass = participant(OnlineThirdClass::class.java) // "method1", OnlineThirdClass::method1

    @Test
    fun `check online checker on simple choreography with manual execution`() {
        val sessionId = UUID.randomUUID()
        val cset = defineCorrelationSet()
                .add(correlation(onlineFirstClass.onMethod("method1", OnlineFirstClass::method1), { sessionId }).extendFromInput { sessionId }.done())
                .add(correlation(onlineFirstClass.onMethod("method2", OnlineFirstClass::method2), { sessionId }).noExtensions())
                .add(correlation(onlineSecondClass.onMethod("method1", OnlineSecondClass::method1), { sessionId }).noExtensions())
                .finish()
        val choreography = Choreography.builder()
                .interaction(external, onlineFirstClass.onMethod("method1", OnlineFirstClass::method1), "#1")
                .interaction(onlineFirstClass, onlineFirstClass.onMethod("method2", OnlineFirstClass::method2), "#2")
                .interaction(onlineFirstClass, onlineSecondClass.onMethod("method1", OnlineSecondClass::method1), "#3")
                .returnFrom(onlineSecondClass.onMethod("method1", OnlineSecondClass::method1), "return #3")
    ...
    fun `check that concurrently running choreographies work`() {
        ...
        val cset1 = defineCorrelationSet()
                .add(correlation(onlineFirstClass.onMethod("method1", OnlineFirstClass::method1), { sessionId1 }).extendFromInput { sessionId1 }.done())
                .add(correlation(onlineFirstClass.onMethod("method2", OnlineFirstClass::method2), { sessionId1 }).noExtensions())
                .add(correlation(onlineSecondClass.onMethod("method1", OnlineSecondClass::method1), { sessionId1 }).noExtensions())
                .finish()
        val cset2 = defineCorrelationSet()
                .add(correlation(onlineSecondClass.onMethod("method2", OnlineSecondClass::method2), { sessionId2 }).extendFromInput { sessionId2 }.done())
                .add(correlation(onlineThirdClass.onMethod("method1", OnlineThirdClass::method1), { sessionId2 }).noExtensions())
                .add(correlation(onlineThirdClass.onMethod("method2", OnlineThirdClass::method2), { sessionId2 }).noExtensions())
                .finish()
        ...
        val choreography2 = Choreography.builder()
                .interaction(external, onlineSecondClass.onMethod("method2", OnlineSecondClass::method2), "#1")
                .interaction(onlineSecondClass, onlineThirdClass.onMethod("method1", OnlineThirdClass::method1), "#2")
                .interaction(onlineThirdClass, onlineThirdClass.onMethod("method2", OnlineThirdClass::method2), "#3")
